...
use(function() {
   ...
   // var url = properties.get("locationURL")  + new Packages.java.net.URLEncoder.encode(request.getParameter("location"),'utf-8');
	var url = properties.get("memberURL") +"?memberId="+new Packages.java.net.URLEncoder.encode(request.getParameter("memberId"),'utf-8');
