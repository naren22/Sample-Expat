...
use(function() {
    ...
    var url = properties.get("providerDetailURL") + request.getParameter("id");
	//var url = "http://dev-uhcg-svcs-providers.uhc.com/api/cdm/uhcg/gi/providers/get?providerId="+request.getParameter("id");
