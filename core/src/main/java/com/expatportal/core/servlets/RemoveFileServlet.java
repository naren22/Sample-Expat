...
@Component(service=Servlet.class,
           property={
                   Constants.SERVICE_DESCRIPTION + "=Remove File Servlet",
                   "sling.servlet.methods=" + HttpConstants.METHOD_POST,
                   "sling.servlet.resourceTypes="+ "mynew/components/structure/remove",
                   "sling.servlet.paths="+ "/bin/file/remove",
                   "sling.servlet.extensions=" + "json"
           })
public class RemoveFileServlet extends SlingAllMethodsServlet {

    private static final long serialVersionUid = 1L;
    Logger log = LoggerFactory.getLogger(RemoveFileServlet.class);
    ...
    protected void doPost(final SlingHttpServletRequest req,
        ...
        try {
            String status=service.deleteFile(req);
