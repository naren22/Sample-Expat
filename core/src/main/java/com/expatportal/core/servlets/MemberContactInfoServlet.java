 ...
 */
@Component(service = Servlet.class, property = { Constants.SERVICE_DESCRIPTION + "=Member Contact Info servlet",
		"sling.servlet.methods=" + HttpConstants.METHOD_GET,
		"sling.servlet.paths=" + "/bin/expatportal/membercontactinfo", "sling.servlet.extensions=" + "" })
public class MemberContactInfoServlet extends SlingAllMethodsServlet {
	...
	private final Logger logger = LoggerFactory.getLogger(MemberContactInfoServlet.class);
	...
	protected void doGet(final SlingHttpServletRequest req, final SlingHttpServletResponse resp)
		...
		try {
			...
			String url = memberService.getMemberContactEndpoint() + "/" + memberId;
