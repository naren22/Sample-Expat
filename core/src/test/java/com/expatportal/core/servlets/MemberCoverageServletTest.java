 ...
 *
 */
public class MemberCoverageServletTest {
	...
	/**
	 * Test method for {@link com.expatportal.core.servlets.MemberCoverageServlet#doPost(org.apache.sling.api.SlingHttpServletRequest, org.apache.sling.api.SlingHttpServletResponse)}.
	 * @throws IOException 
	...
	public void testDoPostSlingHttpServletRequestSlingHttpServletResponse() throws ServletException, IOException, NoSuchFieldException, SecurityException {
		MemberCoverageServlet servlet=new MemberCoverageServlet();
		StringWriter writer = new StringWriter();
		FieldSetter.setField(servlet, servlet.getClass().getDeclaredField("memberService"), memberService);
		Mockito.when(response.getWriter()).thenReturn(new PrintWriter(writer));
		Mockito.when(memberService.getMemberCoverageEndpoint()).thenReturn("http://google.com");
