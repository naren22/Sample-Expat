...
public class MemberContactInfoServletTest {
	...
	public void testDoGet() throws ServletException, IOException {
		...
		MemberContactInfoServlet servlet = new MemberContactInfoServlet();
		Mockito.when(memberService.getMemberContactEndpoint()).thenReturn("https://somevalidendpoint.com/endpoint");
		Mockito.when(response.getWriter()).thenReturn(new PrintWriter("test-data"));
		MemberContactInfoServlet spyObject = Mockito.spy(servlet);
